...
public class ChatHelper {
    ...
    public static String readFontTxt() {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(RRDiscordBridge.instance.getServer().getResource("/font.txt"), "UTF-8"))) {
            String line = "";
     ...
     * <p>
     * If {@code allowSpecial} is false, then all instances of {@code '§'} and newline chars will be replaced with {@code replacement}
     * <p>
     * {@code §} is used for Minecraft color codes which might be annoying to other players that are trying to read the messages
     *
