...
dependencies {
    ...
    implementation(project(":Bukkit 1.1-1.2.5"))
    compileOnly("com.legacyminecraft.poseidon:poseidon-craftbukkit:$poseidonVersion")
    implementation(project(":common"))
}

tasks.named("compileJava").configure {
    dependsOn(":Bukkit 1.1-1.2.5:shadowJar")
}