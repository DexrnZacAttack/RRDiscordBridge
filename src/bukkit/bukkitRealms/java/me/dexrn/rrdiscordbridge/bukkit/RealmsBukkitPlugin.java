...
public class RealmsBukkitPlugin extends BaseBukkitPlugin {
    public RealmsBukkitPlugin(JavaPlugin plugin) {
        super(plugin);
    }
    ...
    public void registerEvents() {
        ...
        pluginManager.registerEvents(new PlayerAchievement(), plugin);
    }
}
