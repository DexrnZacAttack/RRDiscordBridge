...
public class Fabric1201Server extends ModernMinecraftServer {
    public Fabric1201Server(MinecraftServer server) {
        super(server);
    }

    @Override
    public IPlayer getPlayer(String name) {
        return new Fabric1201Player(server.getPlayerList().getPlayerByName(name));
    }
