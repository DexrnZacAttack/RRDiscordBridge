...
public class NeoForgeTradeMod extends AbstractModernMinecraftMod {
    public NeoForgeTradeMod(Semver ver) {
        super(ver);
    }
    ...
    public void init(MinecraftServer server) {
        ...
        NeoForge.EVENT_BUS.register(
                new NeoForgeTradeEventHandler<>(NeoForgeServer::new, NeoForgePlayer::new));
    }
