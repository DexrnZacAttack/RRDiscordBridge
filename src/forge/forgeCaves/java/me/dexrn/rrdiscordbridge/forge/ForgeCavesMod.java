...
import me.dexrn.rrdiscordbridge.forge.impls.ForgeCavesServerHandler;
...
public class ForgeCavesMod extends AbstractModernMinecraftMod {
    public ForgeCavesMod(Semver minecraftVer) {
        super(minecraftVer);
    ...
    public void onServerStarting(FMLServerAboutToStartEvent event) {
        ForgeCavesServerHandler.onServerStarting(event, this);
    }

    @SubscribeEvent
    public void onServerStopping(FMLServerStoppingEvent event) {
        ForgeCavesServerHandler.onServerStopping(event);
    }
}
