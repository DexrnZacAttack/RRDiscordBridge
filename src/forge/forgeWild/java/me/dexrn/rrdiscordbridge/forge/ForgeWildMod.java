...
import me.dexrn.rrdiscordbridge.forge.impls.ForgeWildPlayer;
import me.dexrn.rrdiscordbridge.forge.impls.ForgeWildServer;
...
public class ForgeWildMod extends AbstractModernMinecraftMod {
    public ForgeWildMod(Semver minecraftVer) {
        super(minecraftVer);
    ...
    public void init(MinecraftServer server) {
        EVENT_BUS.register(
                new ForgeCliffsEventHandler<>(ForgeWildServer::new, ForgeWildPlayer::new));
