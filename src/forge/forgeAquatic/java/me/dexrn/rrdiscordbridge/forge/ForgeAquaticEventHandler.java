...
public class ForgeAquaticEventHandler<S extends IServer, P extends IPlayer>
        extends AbstractEventHandler<S, P, MinecraftServer, EntityPlayerMP> {
    public ForgeAquaticEventHandler(
    ...
    public void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        Events.onPlayerJoin(createPlayer((EntityPlayerMP) event.getPlayer()));
    }
    ...
    public void onPlayerLeave(PlayerEvent.PlayerLoggedOutEvent event) {
        Events.onPlayerLeave(createPlayer((EntityPlayerMP) event.getPlayer()));
    }
    ...
    public void onPlayerDeath(LivingDeathEvent event) {
        ...
        if (entity instanceof EntityPlayerMP) {
            Events.onPlayerDeath(
                    ...
                    ((EntityPlayerMP) entity).getCombatTracker().getDeathMessage().getString());
        }
    }

    @SubscribeEvent
    public void onCommand(CommandEvent event) {
        CommandSource s = event.getParseResults().getContext().getSource();
