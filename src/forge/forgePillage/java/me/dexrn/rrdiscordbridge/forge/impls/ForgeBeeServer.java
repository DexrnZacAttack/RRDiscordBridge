...
public class ForgePillageServer implements IServer {
    private final MinecraftServer server;

    public ForgePillageServer(MinecraftServer server) {
        this.server = server;
    }
    ...
    public IPlayer[] getOnlinePlayers() {
        return server.getPlayerList().getPlayers().stream()
                ...
                .map(ForgePillagePlayer::new)
                .toArray(IPlayer[]::new);
    }

    @Override
    public IPlayer getPlayer(String name) {
        return new ForgePillagePlayer(server.getPlayerList().getPlayerByName(name));
    }
    ...
    public IPlayer getPlayer(UUID id) {
        return new ForgePillagePlayer(server.getPlayerList().getPlayer(id));
    }
