...
import me.dexrn.rrdiscordbridge.entrypoint.forge.multiversion.ForgeNetherModsFactory;
...
public class ForgeNetherEntrypoint implements IForgeEntrypoint {
    public ForgeNetherEntrypoint() {
        ...
        try {
            ...
            ForgeNetherModsFactory factory = new ForgeNetherModsFactory();
